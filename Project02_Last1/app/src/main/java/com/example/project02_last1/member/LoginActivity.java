...
import com.example.project02_last1.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NaverIdLoginSDK.INSTANCE.initialize(this, "M_dhrYXByurd_DdaPllM", "sJmYoJQ9gc", "Project02_Last");
...
//        });
    ...
    public void kakaoLogin(Context context){
        ...
        KakaoSdk.init(this,"{59e5223f9cde57c47c3044741a556272}");
            ...
            public void onSuccess() {
                ...
                new NidOAuthLogin().callProfileApi(new NidProfileCallback<NidProfileResponse>() {
                    ...
                    public void onSuccess(NidProfileResponse nidProfileResponse) {
                        ...
                        //id ( key ) <- naver,kakao... sdf@naver.com
