...
import com.example.project02_last1.member.MemberVO;
...
//        binding.fabInsert.setOnClickListener(v->{//insert
...
//        });
    ...
    void select(String query){
        ...
        conn.onExcute((isResult, data) -> {
            ...
            binding.recvCustmer.setAdapter(adapter);
            binding.recvCustmer.setLayoutManager(new LinearLayoutManager(getContext()));
            //list -> Adapter
