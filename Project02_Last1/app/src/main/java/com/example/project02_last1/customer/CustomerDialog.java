...
import com.example.project02_last1.databinding.DialogCustomerBinding;
...
public class CustomerDialog extends Dialog {
    ...
    public CustomerDialog(@NonNull Context context,CustomerVO vo){
        ...
        if(vo==null){
            ...
            binding.btnAlppy.setOnClickListener(v->{
                CustomerVO tempVo = new CustomerVO();

                tempVo.setEmail(binding.edtEmail.getText().toString());
//                tempVo.setGender(binding.tvCusId.isChecked() ? "남" : "여");
